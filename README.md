...
![Sorting Algorithm Performance Graph](diapoz_int.png)

*График демонстрирует время выполнения различных алгоритмов сортировки в зависимости от размера массива,разброс чисел в диапазоне значений int.*
